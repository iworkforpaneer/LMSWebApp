...
<head>
  ...
  <title>LMSWebApp | A | Book Update</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <hr class="sidebar-divider">
            ...
            <h1 class="h3 mb-2 text-gray-800">Information about the books:</h1>
              ...
              <div class="table-responsive">
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $res['bookauthname']; ?></td>
                    <td><?php echo $res['bookcost']; ?></td>
                    <td><?php echo $res['bookquantity']; ?></td>
                    <td><a style="color: green;" href="updateRecord.php?id=<?php echo $res['id']; ?>" data-toggle="tooltip" data-placement="TOP" title="Update"><i class="fas fa-edit"></i></a></td>
                    <td><a style="color: red;" href="deleteRecord.php?id=<?php echo $res['id']; ?>" data-toggle="tooltip" data-placement="TOP" title="Delete"><i class="fas fa-trash-alt"></i></a></td>
                  </tr>
                  <?php
                }
                ?>
