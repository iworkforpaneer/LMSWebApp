...
<head>
  ...
  <title>LMSWebApp | A | Dashboard</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Books Issued</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                          require('connect.php');
                          $query = "SELECT * FROM `studentorders`";
                          $result = mysqli_query($conn, $query);
                          if($result) {
                            $row = mysqli_num_rows($result);
                            if($row) {
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                          $email = $_SESSION['email'];
                          require('connect.php');
                          $sql = "SELECT SUM(fine) AS `sumfine` FROM `finetable`";
            ...
            <h1 class="h3 mb-2 text-gray-800">Book Fine Information:</h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <div class="table-responsive">
                ...
                $sql = "SELECT * FROM `finetable`";
                $query = mysqli_query($conn, $sql);
                $nums = mysqli_num_rows($query);
                while($res = mysqli_fetch_array($query)) {
                ?>
                  <tr>
                    <th scope="row"><?php echo $res['studentname']; ?></th>
                    <td><?php echo $res['studentenrollno']; ?></td>
