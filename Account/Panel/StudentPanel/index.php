...
<head>
  ...
  <title>LMSWebApp | S | Dashboard</title>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="index.php" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><i>Welcome,</i> <br> <u><?php echo $_SESSION['email']; ?></u></span>
            ...
            <div class="col-xl-4 col-md-6 mb-5">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Your Issued Books</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                          $email = $_SESSION['email'];
                          require('connect.php');
                          $query = "SELECT * FROM `studentorders` WHERE `email` = '$email'";
                          $result = mysqli_query($conn, $query);
                          if($result) {
                            $row = mysqli_num_rows($result);
                            if($row) {
            ...
            <div class="col-xl-4 col-md-12 mb-5">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Fine Generated</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">₹ 
                      <?php
                          $email = $_SESSION['email'];
                          require('connect.php');
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <div class="table-responsive">
                ...
                <tbody>
                <?php
                //IMPORTED SESSION VARIABLE FOR VERIFYING THE USER
                $email = $_SESSION['email'];
                include_once('connect.php');
                //IMPORTING DATA FROM DATABASE
                $sql = "SELECT * FROM `studentorders` WHERE `email` = '$email'";
                $result = $conn->query($sql);
