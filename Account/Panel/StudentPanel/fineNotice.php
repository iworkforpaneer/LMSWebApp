...
<head>
  ...
  <title>LMSWebApp | S | Fine Notice</title>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Fine Notice</h1>
          </div>
          <hr class="sidebar-divider">
            ...
            <h1 class="h3 mb-2 text-gray-800"><i>Dear User</i></h1>
            <div class="col-lg-12 mb-8">
            <h5>You have an outstanding amount of fine due for the late submission of your book.<br>Kindly reach out to your Admin where you can clear your due' s after payment</h5>
            </div>
            <div>
            <i>Thank You</i><br>LMSWebAppTeam
            </div>
