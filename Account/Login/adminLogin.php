...
if(isset($_POST['submit'])) {
	...
	$sql = "SELECT * FROM `adminlogindata` WHERE `email` = '$email' AND `password` = '$password'";
	...
	if(mysqli_num_rows($result) == 1) {
        ...
        window.location.href='../Panel/AdminPanel/index.php';
        </script>";
	}
	else {
		echo "<script>
...
<html lang="en">
<head>
	<title>LMSWebApp | Admin Login</title>
	<meta charset="UTF-8">
